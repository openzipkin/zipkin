...
public class ZipkinSpans extends TableImpl<Record> {
  ...
  private static final long serialVersionUID = 2137202900;

  /**
   * The reference instance of <code>test.zipkin_spans</code>
   */
  ...
  /**
   * The column <code>test.zipkin_spans.trace_id</code>.
   */
  public final TableField<Record, Long> TRACE_ID = createField("trace_id",
      org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /**
   * The column <code>test.zipkin_spans.id</code>.
   */
  public final TableField<Record, Long> ID = createField("id",
      org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

  /**
   * The column <code>test.zipkin_spans.name</code>.
   */
  ...
  /**
   * The column <code>test.zipkin_spans.parent_id</code>.
   */
  public final TableField<Record, Long> PARENT_ID = createField("parent_id",
      org.jooq.impl.SQLDataType.BIGINT, this, "");

  /**
   * The column <code>test.zipkin_spans.debug</code>.
   */
  public final TableField<Record, Boolean> DEBUG = createField("debug",
      org.jooq.impl.SQLDataType.BIT, this, "");

  /**
   * The column <code>test.zipkin_spans.start_ts</code>. Used to implement TTL; First
   * Annotation.timestamp() or null
   */
  public final TableField<Record, Long> START_TS = createField("start_ts",
      org.jooq.impl.SQLDataType.BIGINT, this,
      "Used to implement TTL; First Annotation.timestamp() or null");

  /**
   * Create a <code>test.zipkin_spans</code> table reference
   */
  public ZipkinSpans() {
  ...
  /**
   * Create an aliased <code>test.zipkin_spans</code> table reference
   */
