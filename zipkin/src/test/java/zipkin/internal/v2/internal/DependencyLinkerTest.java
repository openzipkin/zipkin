...
public class DependencyLinkerTest {
  static final List<Span> TRACE = TestObjects.TRACE.stream()
  ...
  /**
   * A dependency link is between two services. Given only one span).callCount(we cannot link if we don't know
   * both service names.
   */
  @Test
