...
public class ITV2InMemoryStorage {

  public static class DependenciesTest extends zipkin.storage.DependenciesTest {
    final V2InMemoryStorage storage = V2InMemoryStorage.newBuilder().build();

    @Override protected V2InMemoryStorage storage() {
      return storage;
    }
  ...
  public static class StrictTraceIdFalseTest extends zipkin.storage.StrictTraceIdFalseTest {
    final V2InMemoryStorage storage = V2InMemoryStorage.newBuilder().strictTraceId(false).build();
