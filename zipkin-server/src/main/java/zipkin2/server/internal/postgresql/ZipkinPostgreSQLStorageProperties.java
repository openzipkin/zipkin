...
class ZipkinPostgreSQLStorageProperties implements Serializable { // for Spark jobs
  ...
  private String determineJdbcUrl() {
    ...
    // TODO: determine postgres connection args required (schemas / RDS / SSL might be a big one here)
