...
public class SpanBytesDecoderTest {
  ...
  @Test public void spanRoundTrip_shared() {
   ...
   */
  @Test public void specialCharsInJson() {
    assertThat(
  ...
  @Test public void falseOnEmpty_inputSpans() {
   ...
   */
  @Test public void niceErrorOnMalformed_inputSpans() {
    thrown.expect(IllegalArgumentException.class);
  ...
  @Test public void spansRoundTrip() {
  ...
  @Test public void spanRoundTrip_noRemoteServiceName() {
    span = span.toBuilder()
  ...
  @Test public void spanRoundTrip_noAnnotations_rootServerSpan() {
  ...
  @Test public void spanRoundTrip_noAnnotations_rootServerSpan_incomplete() {
  ...
  @Test public void spanRoundTrip_noAnnotations_rootServerSpan_shared() {
