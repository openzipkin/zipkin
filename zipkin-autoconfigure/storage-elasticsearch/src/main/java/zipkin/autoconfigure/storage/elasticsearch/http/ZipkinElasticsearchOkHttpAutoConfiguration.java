 ...
 * straight-forward. For example, even though the hosts might contain http urls, in the case of
 * Amazon, the hosts collection can be blank (lookup host by domain name).
 */
@Configuration
...
class ZipkinElasticsearchOkHttpAutoConfiguration {
  ...
  OkHttpClient elasticsearchOkHttpClient(
    ...
    OkHttpClient.Builder builder =
        elasticsearchOkHttpClientBuilder != null
