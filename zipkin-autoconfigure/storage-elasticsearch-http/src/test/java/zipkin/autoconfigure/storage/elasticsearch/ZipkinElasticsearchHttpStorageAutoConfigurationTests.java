...
import zipkin.autoconfigure.storage.elasticsearch.http.ZipkinElasticsearchStorageHttpAutoConfiguration;
import zipkin.storage.elasticsearch.ElasticsearchStorage;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.boot.test.util.EnvironmentTestUtils.addEnvironment;

public class ZipkinElasticsearchHttpStorageAutoConfigurationTests {
  ...
  public void doesntProvidesStorageComponent_whenStorageTypeNotElasticsearch() {
    ...
    context.register(PropertyPlaceholderAutoConfiguration.class,
        ZipkinElasticsearchStorageHttpAutoConfiguration.class);
    context.refresh();
