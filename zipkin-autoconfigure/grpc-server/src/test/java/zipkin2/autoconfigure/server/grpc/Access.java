...
public final class Access {
  ...
  public static void registerGrpcServerProperties(AnnotationConfigApplicationContext context) {
    context.register(
        PropertyPlaceholderAutoConfiguration.class, EnableZipkinGrpcServerProperties.class);
  }
