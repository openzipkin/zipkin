...
class ExpensiveEndpointSpec extends Specification with TupleConversions {
  noDetailedDiffs()
  ...
  "MostExpensiveEndpoints" should {
    "return 100 entries with runtimes 1" in {
      JobTest("com.twitter.zipkin.hadoop.MostExpensiveEndpoint").
        arg("input", "inputFile").
