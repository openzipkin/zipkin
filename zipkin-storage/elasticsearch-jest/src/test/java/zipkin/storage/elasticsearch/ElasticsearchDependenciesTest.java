...
import zipkin.storage.elasticsearch.jest.ElasticsearchJestDependencyWriter;
import zipkin.storage.elasticsearch.jest.ElasticsearchJestTestGraph;
...
public class ElasticsearchDependenciesTest extends DependenciesTest {
  ...
  public ElasticsearchDependenciesTest() {
    this.storage = ElasticsearchJestTestGraph.INSTANCE.storage.get();
  }
  ...
  @VisibleForTesting void writeDependencyLinks(List<DependencyLink> links, long timestampMillis) {
    ...
    try {
      ElasticsearchJestDependencyWriter.writeDependencyLinks(storage.client(), links, index,
