...
final class SelectRemoteServiceNames implements Function<DSLContext, List<String>> {
  ...
  public List<String> apply(DSLContext context) {
    return context
      .selectDistinct(ZipkinSpans.ZIPKIN_SPANS.REMOTE_SERVICE_NAME)
      ...
      .and(ZipkinSpans.ZIPKIN_SPANS.REMOTE_SERVICE_NAME.notEqual(""))
      .orderBy(ZipkinSpans.ZIPKIN_SPANS.REMOTE_SERVICE_NAME)
      .fetch(ZipkinSpans.ZIPKIN_SPANS.REMOTE_SERVICE_NAME);
  }
