...
final class PostgresSpanStore implements SpanStore, Traces, ServiceAndSpanNames {
  ...
  PostgresSpanStore(PostgresStorage storage, Schema schema) {
  ...
  @Override public Call<List<String>> getRemoteServiceNames(String serviceName) {
    ...
    return dataSourceCallFactory.create(new SelectRemoteServiceNames(schema,
