 ...
 * the License.
 */
package zipkin.storage.postgresql;
...
import static zipkin.storage.postgresql.internal.generated.tables.ZipkinAnnotations.ZIPKIN_ANNOTATIONS;
import static zipkin.storage.postgresql.internal.generated.tables.ZipkinDependencies.ZIPKIN_DEPENDENCIES;
import static zipkin.storage.postgresql.internal.generated.tables.ZipkinSpans.ZIPKIN_SPANS;

public final class PostgreSQLStorage implements StorageComponent {
  ...
  public final boolean strictTraceId;
  ...
  @Override public SpanStore spanStore() {
    return new PostgreSQLSpanStore(datasource, context, schema.get(), strictTraceId);
  }
  ...
  @Override public AsyncSpanConsumer asyncSpanConsumer() {
    PostgreSQLSpanConsumer spanConsumer = new PostgreSQLSpanConsumer(datasource, context, schema.get());
