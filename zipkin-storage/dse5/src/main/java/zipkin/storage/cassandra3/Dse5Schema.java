...
final class Dse5Schema {
  private static final Logger LOG = LoggerFactory.getLogger(Dse5Schema.class);
  ...
  static final String DEFAULT_KEYSPACE = "zipkin-dse5";
  private static final String SCHEMA_RESOURCE = "/dse5-schema.cql";
  ...
  static void applyCqlFile(String keyspace, Session session, String resource) {
    try (Reader reader = new InputStreamReader(Dse5Schema.class.getResourceAsStream(resource))) {
