...
resolvers ++= Seq(
  ...
  "local" at ("file:" + System.getProperty("user.home") + "/.m2/repository/")) ++ {
  	  if ("true".equalsIgnoreCase(System.getenv("SBT_TRAVIS_CI")))
	     Seq("travisci-central" at "http://maven.travis-ci.org/nexus/content/repositories/central/",  "travisci-sonatype" at "http://maven.travis-ci.org/nexus/content/repositories/sonatype/")
	  else Seq.empty[Resolver]
  }
