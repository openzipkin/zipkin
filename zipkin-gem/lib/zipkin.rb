...
$LOAD_PATH.push(File.expand_path("gen-rb", File.dirname(__FILE__)))
require File.expand_path("gen-rb/zipkin_query", File.dirname(__FILE__))

require 'zipkin/careless_scribe'
require 'zipkin/zipkin_client'

module Zipkin extend self
