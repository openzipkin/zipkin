    ...
    module Zipkin
      module ZipkinQuery
        class Client
          ...
          def getThriftToString(trace_id, key, thrift_idl)
            send_getThriftToString(trace_id, key, thrift_idl)
            return recv_getThriftToString()
          end

          def send_getThriftToString(trace_id, key, thrift_idl)
            send_message('getThriftToString', GetThriftToString_args, :trace_id => trace_id, :key => key, :thrift_idl => thrift_idl)
          end

          def recv_getThriftToString()
            result = receive_message(GetThriftToString_result)
            return result.success unless result.success.nil?
            raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'getThriftToString failed: unknown result')
          end
        ...
        class Processor
          ...
          def process_getThriftToString(seqid, iprot, oprot)
            args = read_args(iprot, GetThriftToString_args)
            result = GetThriftToString_result.new()
            result.success = @handler.getThriftToString(args.trace_id, args.key, args.thrift_idl)
            write_result(result, oprot, 'getThriftToString', seqid)
          end
        ...
        class GetThriftToString_args
          ...
          FIELDS = {
            ...
            THRIFT_IDL => {:type => ::Thrift::Types::STRING, :name => 'thrift_idl'}
          }
        ...
        class GetThriftToString_result
          include ::Thrift::Struct, ::Thrift::Struct_Union
          SUCCESS = 0
