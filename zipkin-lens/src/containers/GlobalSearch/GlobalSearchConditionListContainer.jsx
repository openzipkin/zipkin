...
import GlobalSearchConditionList from '../../components/GlobalSearch/GlobalSearchConditionList';
...
const GlobalSearchConditionListContainer = connect(
  mapStateToProps,
  mapDispatchToProps,
)(GlobalSearchConditionList);

export default GlobalSearchConditionListContainer;
